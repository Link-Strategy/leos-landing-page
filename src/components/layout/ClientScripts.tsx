...
export default function ClientScripts() {
  useEffect(() => {
    ...
    // Add event listeners just in case
  ...
  return (
    <>
      ...
      <Script 
        src="/wp-includes/js/dist/i18n.min.js?ver=c26c3dc7bed366793375" 
        strategy="afterInteractive" 
        onLoad={() => {
          if (typeof window !== 'undefined' && (window as any).wp?.i18n) {
            (window as any).wp.i18n.setLocaleData( { 'text direction\u0004ltr': [ 'ltr' ] } );
          }
        }}
      />
